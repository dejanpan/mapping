...
def plot_confusion_matrix(conf_arr, nr):
    ...
    plt.clf()
    fig = plt.figure()
    plt.xticks( arange(nr), ('Cylinder',  'Flat',  'Tetrapak', 'Box', 'Tube',  'Other'), rotation=90)
    plt.yticks( arange(nr), ('Cylinder',  'Flat',  'Tetrapak', 'Box', 'Tube',  'Other') )
#    plt.xticks( arange(nr), ('bowl',  'box_medium',  'box_small',  'cylinder_big',  'cylinder_short',  'cylinder_small', 'flat_big', 'flat_small', 'pan', 'plate', 'tetrapak'), rotation=90)
#    plt.yticks( arange(nr), ('bowl',  'box_medium',  'box_small',  'cylinder_big',  'cylinder_short',  'cylinder_small', 'flat_big', 'flat_small', 'pan', 'plate', 'tetrapak') )
    plt.title('GRSD Confusion Matrix for Test Views')
#    plt.title('GRSD Confusion Matrix for Novel Objects')
