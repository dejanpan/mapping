...
class RansacTransformation
{
  public:
    ...
    Eigen::Matrix4f
        getTransformFromMatches (const std::vector<Eigen::Vector4f, Eigen::aligned_allocator<
            Eigen::Vector4f> > & source_feature_locations_3d, const std::vector<Eigen::Vector4f,
            Eigen::aligned_allocator<Eigen::Vector4f> > & target_feature_locations_3d,
    ...
    bool
    getRelativeTransformationTo (const std::vector<Eigen::Vector4f, Eigen::aligned_allocator<
        Eigen::Vector4f> > & source_feature_locations_3d, const std::vector<Eigen::Vector4f,
        Eigen::aligned_allocator<Eigen::Vector4f> > & target_feature_locations_3d, std::vector<
        cv::DMatch>* initial_matches, Eigen::Matrix4f& resulting_transformation, float& rmse,
